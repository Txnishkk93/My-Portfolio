 ...
 const education = [
   {
     ...
     year: "2018 - 2022",
     description: "Graduated with honors. Focused on web technologies, algorithms, and software engineering principles.",
   },
   {
     degree: "Full Stack Development Bootcamp",
     institution: "Tech Academy",
     year: "2022",
     description: "Intensive 12-week program covering modern web development stack including React, Node.js, and databases.",
   },
   {
